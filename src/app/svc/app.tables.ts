/***********************************************************************
* Automatically generated on 4/20/2021 10:28:03 AM
***********************************************************************/
...
export class TblSurveyRelEventsHeader extends TableBase {

  public rows:Array<TblSurveyRelEventsHeaderRow> = [];
  ...
  constructor(public http:HttpClient,public apiUrl:string, public tables:Array<any>, public apiCommon:AppCommonMethodsService) {
    ...
    this.tableCode="svyqrelev";

	this.columns.push(new ColumnInfo('SVY_HDR_ID', 'string', '', '', '', 0, -1, -1, -1, -1, false, false, false, this));
	this.columns.push(new ColumnInfo('SVY_HDR_NOD_ID', 'string', '', '', '', -1, -1, -1, -1, -1, false, false, false, this));

    this.InitializeTable();

  }

  Add(row?:TblSurveyRelEventsHeaderRow):TblSurveyRelEventsHeaderRow
  {
    return super.Add(row);
  }

  NewRow():TblSurveyRelEventsHeaderRow{return new TblSurveyRelEventsHeaderRow();}
  GetRows():Array<TblSurveyRelEventsHeaderRow>{return this.rows;}
  public set currentRow(value:TblSurveyRelEventsHeaderRow){super.__currentRow(value);}
  public get currentRow():TblSurveyRelEventsHeaderRow{return super.__currentRow();}
  public TableLinks():Array<string>{return this._tableLinks;}
  public Links():Array<any>{return this._links;}
  public get dirtyRows():Array<TblSurveyRelEventsHeaderRow>{return super.__dirtyRows();}
  public get newRows():Array<TblSurveyRelEventsHeaderRow>{return super.__newRows();}


}

export class TblSurveyRelEventsHeaderRow extends TableRowBase{
	constructor(
		public SVY_HDR_ID?:string, 
		public SVY_HDR_NOD_ID?:string){
    super();

  }

  // Returs the table object where the row is a member of.
  public get Table():TblSurveyRelEventsHeader{ return super._Table(); }
